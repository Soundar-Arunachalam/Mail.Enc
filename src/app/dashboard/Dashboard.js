            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-xl-4 text-center">
                <div className="col mb-4">
                    ...
                    <div className="card-body">
                        <img src="../img/Mail.Enc/keyring.svg"></img>
                    </div>
                ...
                <div className="col mb-4">
                    ...
                    <div className="card-body">
                        <img src="../img/Mail.Enc/encryption.svg"></img>
                    </div>
                    <div className="card-footer">
                    {l10n.map.dashboard_link_encrypt_decrypt_keys}
                    </div>
                    </Link>
                </div>
                <div className="col mb-4">
                    ...
                    <div className="card-body">
                        <img src="../img/Mail.Enc/authorized.svg"></img>
                    </div>
                    <div className="card-footer">
