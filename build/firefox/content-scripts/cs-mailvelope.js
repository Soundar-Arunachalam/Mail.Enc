...
class GmailIntegration {
  ...
  createEditorButton() {
    ...
    const btnElement = `<a id="editorBtn" class="mv-editor-btn" title="${map.encrypt_frame_btn_label}"><div class="mv-editor-btn-content"><img src="../img/Mail.Enc/logo.png"></div></a>`;
