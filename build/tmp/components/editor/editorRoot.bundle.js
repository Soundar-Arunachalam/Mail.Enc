...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#sign-msg-option{color:#20323d}.collapsed[data-target="#sign-msg-option"] span.icon:before{content:"\\e900"}[data-target="#sign-msg-option"]:not(.collapsed) span.icon:before{content:"\\e903"}
`, ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.recipients-input tags-input .tags .tag-item{font-family:"Poppins",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;font-weight:500;background-color:#e2f3ff;border-color:#d7eeff;transition:background-color 0.3s, border-color 0.3s}.recipients-input tags-input .tags .remove-button{color:inherit}.recipients-input tags-input .tags .tag-primary{color:#70c2ff;background-color:#e2f3ff;border-color:#d7eeff}.recipients-input tags-input .tags .tag-primary hr{border-top-color:#bee3ff}.recipients-input tags-input .tags .tag-primary .alert-link{color:#3dacff}.recipients-input tags-input .tags .tag-primary .remove-button{color:#70c2ff}.recipients-input tags-input .tags .tag-secondary{color:#9aa8b3;background-color:#ebeef0;border-color:#e3e7ea}.recipients-input tags-input .tags .tag-secondary hr{border-top-color:#d4dbdf}.recipients-input tags-input .tags .tag-secondary .alert-link{color:#7d8f9d}.recipients-input tags-input .tags .tag-secondary .remove-button{color:#9aa8b3}.recipients-input tags-input .tags .tag-success{color:#73d67c;background-color:#e3f7e5;border-color:#d8f4da}.recipients-input tags-input .tags .tag-success hr{border-top-color:#c4eec7}.recipients-input tags-input .tags .tag-success .alert-link{color:#4cca57}.recipients-input tags-input .tags .tag-success .remove-button{color:#73d67c}.recipients-input tags-input .tags .tag-info{color:#b68cff;background-color:#f0e8ff;border-color:#ebdfff}.recipients-input tags-input .tags .tag-info hr{border-top-color:#dbc6ff}.recipients-input tags-input .tags .tag-info .alert-link{color:#9659ff}.recipients-input tags-input .tags .tag-info .remove-button{color:#b68cff}.recipients-input tags-input .tags .tag-warning{color:#ffd966;background-color:#fff7e0;border-color:#fff4d4}.recipients-input tags-input .tags .tag-warning hr{border-top-color:#ffedbb}.recipients-input tags-input .tags .tag-warning .alert-link{color:#fc3}.recipients-input tags-input .tags .tag-warning .remove-button{color:#ffd966}.recipients-input tags-input .tags .tag-danger{color:#ff7070;background-color:#ffe2e2;border-color:#ffd7d7}.recipients-input tags-input .tags .tag-danger hr{border-top-color:#ffbebe}.recipients-input tags-input .tags .tag-danger .alert-link{color:#ff3d3d}.recipients-input tags-input .tags .tag-danger .remove-button{color:#ff7070}.recipients-input tags-input .tags .tag-light{color:#f3f8fb;background-color:#fdfefe;border-color:#fcfdfe}.recipients-input tags-input .tags .tag-light hr{border-top-color:#e9f0f8}.recipients-input tags-input .tags .tag-light .alert-link{color:#cde2ee}.recipients-input tags-input .tags .tag-light .remove-button{color:#f3f8fb}.recipients-input tags-input .tags .tag-dark{color:#3e5765;background-color:#d8dde0;border-color:#c9d0d4}.recipients-input tags-input .tags .tag-dark hr{border-top-color:#bbc4c9}.recipients-input tags-input .tags .tag-dark .alert-link{color:#2b3c45}.recipients-input tags-input .tags .tag-dark .remove-button{color:#3e5765}.recipients-input tags-input .tags.focused{background-color:#fff;border-color:#70c2ff;box-shadow:0 0 5px rgba(112,194,255,0.5)}.recipients-input tags-input .tags .tag-item:before{font-family:'MailvelopeIcons' !important;speak:none;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;line-height:1;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.recipients-input tags-input .tags .tag-success:before{content:"\\e90f \\00a0"}.recipients-input tags-input .tags .tag-danger:before{content:"\\e909 \\00a0"}.recipients-input tags-input.ng-invalid .tags,.recipients-input.has-error tags-input .tags{border-color:#ff7070;box-shadow:none}.recipients-input tags-input.ng-invalid .tags.focused,.recipients-input.has-error tags-input .tags.focused{border-color:#ff7070;box-shadow:0 0 0 .2rem rgba(255,112,112,0.25)}.recipients-input tags-input .tags .input{font-family:"Poppins",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;width:auto !important}.recipients-input .alert{margin:10px 0 5px}.recipients-input tags-input .tags{transition:border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out}
`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.fileUpload{position:relative}.fileUpload .area{background-color:rgba(229,238,244,0.75);border:2px dashed #7b8c99;padding:0.75rem}.fileUpload .overlay{position:absolute;top:0;width:100%;height:100%;visibility:hidden;border:2px dashed #3e5765;background-color:rgba(229,238,244,0.9);opacity:0;transition:visibility 0.3s 0s, opacity 0.3s ease-out}.fileUpload .overlay.active{visibility:visible;opacity:1}
`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.m-spinner-fullscreen{position:absolute;z-index:1049;height:2em;width:2em;overflow:visible;margin:auto;top:0;left:0;bottom:0;right:0}.m-spinner-fullscreen:before{content:'';display:block;position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(255,255,255,0.5)}.m-spinner-inline{display:flex;justify-content:center;margin:60px auto 60px}.m-spinner-fullscreen .symbol,.m-spinner-inline .symbol{position:relative;display:flex;justify-content:space-between;width:40px;height:40px}.m-spinner-fullscreen .symbol>div,.m-spinner-inline .symbol>div{width:100%;height:100%;border-radius:50%;background-color:#70c2ff;opacity:0.6;position:absolute;top:0;left:0;animation:bouncedelay 2.0s infinite ease-in-out;animation-fill-mode:both}.m-spinner-fullscreen .symbol .bounce2,.m-spinner-inline .symbol .bounce2{animation-delay:-1.0s}@keyframes bouncedelay{0%,100%{transform:scale(0)}50%{transform:scale(1)}}
`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
"use strict";
/*!**********************************************************!*\
  !*** ./src/components/editor/editorRoot.js + 43 modules ***!
  \**********************************************************/
...
var EditorModalFooter = __webpack_require__(213);
...
var RecipientInput = __webpack_require__(4);
...
class RecipientInput_RecipientInput extends (external_React_default()).Component {
  constructor(props) {
    super(props);
    this.id = getUUID();
  }
  ...
  render() {
    ...
    }, /*#__PURE__*/external_React_default().createElement("tags-input", {
    ...
    }, /*#__PURE__*/external_React_default().createElement("auto-complete", {
    ...
    }, /*#__PURE__*/external_React_default().createElement("strong", null, map.editor_key_not_found), " ", /*#__PURE__*/external_React_default().createElement("span", null, map.editor_key_not_found_msg)), /*#__PURE__*/external_React_default().createElement("div", {
...
RecipientInput_RecipientInput.propTypes = {
  ...
  onChangeRecipient: (prop_types_default()).func,
...
var FilePanel = __webpack_require__(465);
...
var editor = __webpack_require__(949);
...
class Editor extends (external_React_default()).Component {
  ...
  handleChangeRecipient(error) {
    this.setState(prevState => {
      const errorState = {
        recipientsError: prevState.recipientsError,
        recipientsCcError: prevState.recipientsCcError,
        ...error
      };
      return {
        ...errorState,
        encryptDisabled: errorState.recipientsError || errorState.recipientsCcError || !prevState.recipients.length
      };
    });
  }
...
var editorRoot = __webpack_require__(216);
