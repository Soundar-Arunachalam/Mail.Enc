...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#sign-msg-option{color:#757575}.collapsed[data-target="#sign-msg-option"] span.icon:before{content:"\\e900"}[data-target="#sign-msg-option"]:not(.collapsed) span.icon:before{content:"\\e903"}
`, ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.m-spinner-fullscreen{position:absolute;z-index:1049;height:2em;width:2em;overflow:visible;margin:auto;top:0;left:0;bottom:0;right:0}.m-spinner-fullscreen:before{content:'';display:block;position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(255,255,255,0.5)}.m-spinner-inline{display:flex;justify-content:center;margin:60px auto 60px}.m-spinner-fullscreen .symbol,.m-spinner-inline .symbol{position:relative;display:flex;justify-content:space-between;width:40px;height:40px}.m-spinner-fullscreen .symbol>div,.m-spinner-inline .symbol>div{width:100%;height:100%;border-radius:50%;background-color:#182ad3;opacity:0.6;position:absolute;top:0;left:0;animation:bouncedelay 2.0s infinite ease-in-out;animation-fill-mode:both}.m-spinner-fullscreen .symbol .bounce2,.m-spinner-inline .symbol .bounce2{animation-delay:-1.0s}@keyframes bouncedelay{0%,100%{transform:scale(0)}50%{transform:scale(1)}}
`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
